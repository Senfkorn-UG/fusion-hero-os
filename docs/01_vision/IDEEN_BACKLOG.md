...
- **Status:** OFFEN in diesem Repo — laut User müsste eine Fassung **bei Grok** existieren. Kandidat für externe Teil-Umsetzung: Repo `95guknow/mister-jailbait-gui` (JS/TS-GUI, Inhalt noch nicht geprüft).
