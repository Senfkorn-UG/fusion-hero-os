...
- **Status:** TEILWEISE — Scaffold `fusion_hero_os/modules/image_orchestrator/` (Dry-Run, YAML Identity, Rate-Limiter, 2026-07-05). Echte Bild-API + mister-builder-gui-Anbindung offen.
