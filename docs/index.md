...
- **L0** Edge (phone / audio mesh-only `100.x`)
- **L1** Mainframe (control plane, secrets)
- **L2** Mesh anchor (`fusion-mesh-exit` always-on)
- **L3** GKE Autopilot (`senfkorn-gke-cluster`, force_cluster only)

## Docs

Use the navigation tabs for architecture, mesh, ops, security, and dissertation material.
