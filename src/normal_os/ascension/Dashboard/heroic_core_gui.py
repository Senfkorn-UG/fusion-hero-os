...
class HeroicCoreGUI:
    ...
    def _create_widgets(self):
        ...
        notebook.add(tab3, text="Info & Hilfe")

        self._build_info_tab(tab3)
...
• Vollständig ressourcenoptimiert (deque, Precomputed Maps, begrenzte History)

Alle Funktionen sind leichtgewichtig und direkt im Core geladen.
