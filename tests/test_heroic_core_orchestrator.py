...
Hinweis: Die Variante in core/ (root) hat weiterhin den Immer-True-Stub;
getestet wird hier bewusst die echte fusion_hero_os-Variante.
"""
import pytest
...
def test_master_seed_verify_integrity_is_real():
    """verify_integrity() prüft echt: nur der kanonische state_hash() gilt."""
    seed = MasterSeed()
