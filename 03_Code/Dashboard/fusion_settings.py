...
SETTINGS_SCHEMA: List[Dict[str, Any]] = [
    ...
    {
        "key": "FUSION_HERO_POLL_INTERVAL_SEC",
        "label": "Held-Autoupdate Polling",
        "description": "Logisches Polling Interaktion zum Held (Standard 60 s = 1 Min). Android-Erinnerung nach 5 Min Idle.",
        "type": "enum",
        "group": "mainframe",
        "scope": "runtime",
        "default": "60",
    ...
    {
        "key": "FUSION_HERO_REMINDER_AFTER_SEC",
        "label": "Held-Erinnerung Idle",
        "description": "Android System-Notification wenn so lange keine Interaktion zum Held (Standard 300 s = 5 Min).",
        "type": "enum",
        "group": "mainframe",
        "scope": "runtime",
        "default": "300",
        "options": [
            {"value": "300", "label": "5 Min (Standard)"},
            {"value": "600", "label": "10 Min"},
            {"value": "180", "label": "3 Min"},
        ],
    },
    {
        "key": "FUSION_HERO_AUTOUPDATE",
        "label": "Held-Autoupdate",
        "description": "1-Min-Polling + 5-Min-Android-Erinnerung aktivieren.",
        "type": "bool",
        "group": "mainframe",
        "scope": "runtime",
        "default": "1",
