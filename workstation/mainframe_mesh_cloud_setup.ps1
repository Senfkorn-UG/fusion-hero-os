...
if (-not $SkipSupabaseCheck -and -not (Test-Path $DashboardEnv)) {
    ...
    Write-Host "  Projekt: https://supabase.com/dashboard/project/YOUR_SUPABASE_PROJECT_REF" -ForegroundColor DarkGray
...
$env:PUBLIC_SUPABASE_PROJECT_REF = "YOUR_SUPABASE_PROJECT_REF"
